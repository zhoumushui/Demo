...
public class SpectrumActivity extends Activity {
	...
	private void initialLayout() {
		ImageLayout spectrum035 = (ImageLayout) findViewById(R.id.spectrum035);
		spectrum035.init(R.drawable.spectrum_035, "035", getResources()
				.getColor(R.color.fancy_white));

		ImageLayout spectrum034 = (ImageLayout) findViewById(R.id.spectrum034);
		spectrum034.init(R.drawable.spectrum_034, "034", getResources()
				.getColor(R.color.fancy_yellow));

		ImageLayout spectrum033 = (ImageLayout) findViewById(R.id.spectrum033);
		spectrum033.init(R.drawable.spectrum_033, "033", getResources()
				.getColor(R.color.fancy_white));

		ImageLayout spectrum032 = (ImageLayout) findViewById(R.id.spectrum032);
		spectrum032.init(R.drawable.spectrum_032, "032", getResources()
				.getColor(R.color.fancy_teal));

		ImageLayout spectrum031 = (ImageLayout) findViewById(R.id.spectrum031);
		spectrum031.init(R.drawable.spectrum_031, "031", getResources()
				.getColor(R.color.fancy_red));

		ImageLayout spectrum030 = (ImageLayout) findViewById(R.id.spectrum030);
		spectrum030.init(R.drawable.spectrum_030, "030", getResources()
				.getColor(R.color.fancy_red));
		...
		ImageLayout spectrum028 = (ImageLayout) findViewById(R.id.spectrum028);
		spectrum028.init(R.drawable.spectrum_028, "028", getResources()
				.getColor(R.color.fancy_green));

		ImageLayout spectrum027 = (ImageLayout) findViewById(R.id.spectrum027);
		spectrum027.init(R.drawable.spectrum_027, "027", getResources()
				.getColor(R.color.fancy_white));

		ImageLayout spectrum026 = (ImageLayout) findViewById(R.id.spectrum026);
		spectrum026.init(R.drawable.spectrum_026, "026", getResources()
				.getColor(R.color.fancy_white));

		ImageLayout spectrum025 = (ImageLayout) findViewById(R.id.spectrum025);
		spectrum025.init(R.drawable.spectrum_025, "025", getResources()
				.getColor(R.color.fancy_red));

		ImageLayout spectrum024 = (ImageLayout) findViewById(R.id.spectrum024);
		spectrum024.init(R.drawable.spectrum_024, "024", getResources()
				.getColor(R.color.fancy_white));

		ImageLayout spectrum023 = (ImageLayout) findViewById(R.id.spectrum023);
		spectrum023.init(R.drawable.spectrum_023, "023", getResources()
				.getColor(R.color.fancy_white));

		ImageLayout spectrum022 = (ImageLayout) findViewById(R.id.spectrum022);
		spectrum022.init(R.drawable.spectrum_022, "022", getResources()
				.getColor(R.color.fancy_blue));

		ImageLayout spectrum021 = (ImageLayout) findViewById(R.id.spectrum021);
		spectrum021.init(R.drawable.spectrum_021, "021", getResources()
				.getColor(R.color.fancy_green));
